...
% C major scale, one octave, 6th string root
\draw [red] (f8m  |- s6) circle (5pt) node {2};
\draw       (f10m |- s6) circle (5pt) node {4};
\draw       (f7m  |- s5) circle (5pt) node {1};
\draw       (f8m  |- s5) circle (5pt) node {2};
\draw       (f10m |- s5) circle (5pt) node {4};
\draw       (f7m  |- s4) circle (5pt) node {1};
\draw       (f9m  |- s4) circle (5pt) node {3};
\draw [red] (f10m |- s4) circle (5pt) node {4};
% C major scale, one octave, 5th string root
\draw [red] (f3m  |- s5) circle (5pt) node {2};
\draw       (f5m  |- s5) circle (5pt) node {4};
\draw       (f2m  |- s4) circle (5pt) node {1};
\draw       (f3m  |- s4) circle (5pt) node {2};
\draw       (f5m  |- s4) circle (5pt) node {4};
\draw       (f2m  |- s3) circle (5pt) node {1};
\draw       (f4m  |- s3) circle (5pt) node {3};
\draw [red] (f5m  |- s3) circle (5pt) node {4};
\end{tikzpicture}
\end{document}
